...
export const Admin = () => {
  const menus = [
    ...
    { name: "Dashboard", link: "/completed", icon: FaCheckCircle },
    { name: "Report", link: "/delivery", icon: FiFolder },
    {
      name: "Masters",
      link: "/master",
  ...
  return (
    ...
    //         <h1 className={`${open?"text-[15px]  ml-3 text-xl text-gray-200 font-bold":"hidden"}`}>
    //           Groups
    //         </h1>
    //         <i
    ...
    // </section>
    // <div x-data="setup()">
    //   <div class="min-h-screen flex flex-col flex-auto  flex-shrink-0 antialiased bg-[#363636]  dark:bg-gray-700 text-black dark:text-white">
       

       
    //     <div class="h-full mt-14 mb-10 md:ml-64">
    //       <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
    //         <div class="bg-[#5ce881] dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-black font-medium group">
    ...
    //           </div>
    //         </div>
    //         <div class="bg-[lightblue] dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-black font-medium group">
    //           <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
    //             <svg
    //               width="30"
    //               height="30"
    ...
    //           </div>
    //         </div>
    //         <div class="bg-[pink] dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-black font-medium group">
    //           <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
    //             <svg
    //               width="30"
    //               height="30"
    ...
    //           </div>
    //         </div>
    //         <div class="bg-[orange] dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-black font-medium group">
    //           <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
    //             <svg
    //               width="30"
    //               height="30"
    ...
    //                           style={{ outline: "none;" }}
    //                         >
    //                           For Muhammed has been Shipped Successfully
    //                         </a>
    //                       </div>
    //                       <div class="flex-shrink-0 ml-2">
    //                         <a
    ...
    //       <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-white dark:text-white">
